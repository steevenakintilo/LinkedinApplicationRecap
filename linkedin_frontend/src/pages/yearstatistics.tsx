...
const MonthStatistics = () => {
    ...
    const dict_number_of_application_per_year_value_overtime = generate_list_of_dict(retrieved_data.number_of_application_per_year_value_sorted,retrieved_data.number_of_application_over_time_year,10)
    ...
    const chart_number_of_application_per_year_overtime = make_a_graphic("line" , dict_number_of_application_per_year_value_overtime,"Evolution du nombres de candidatures au cour des années")
    ...
    const chart_number_of_application_per_year_value_rate_sorted = make_a_graphic("bar" , dict_number_of_application_per_year_value_value_sorted,"Nombres de fois que tu as postulé par an")
    ...
    return (
        <div className="backgroundcolour">
            ...
            {add_space(5)}
            <h1 className="center_text">Statistiques liées  aux années 📊 :</h1>
            {add_space(7)}
